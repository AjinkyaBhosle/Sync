                ...
                allOf:
                  - type: string
                    description: >-
                      ...
                      - Optional, but either `audioId` or `musicIndex` should be
                      provided to identify the exact track.
                    example: e231****-****-****-****-****8cadc7dc
              musicIndex:
                allOf:
                  - type: number
              ...
              callBackUrl:
                allOf:
                  - type: string
                    format: uri
                    description: >-
                      The URL to receive WAV conversion completion
                      notification.  
                      ...
                      Callbacks](./convert-to-wav-format-callbacks)

                      - Alternatively, you can use the get WAV conversion
                      details endpoint to poll task status
                    example: https://api.example.com/callback
            required: true
            requiredProperties:
        ...
        taskId:
          schema:
            - type: string
              required: true
              description: >-
                The task ID returned from the Separate Vocals from Music
                endpoint. Used to retrieve detailed information about a specific
                vocal separation task, including download URLs for all separated
                audio components.
      header: {}
      cookie: {}
    body: {}
                  ...
                  - type: object
                    properties:
                      ...
                      musicId:
                        type: string
                        description: >-
                          The ID of the source music track that was processed
                      ...
                      musicIndex:
                        type: integer
                        description: >-
                          The index position of the track within the original
                          generation task
                      completeTime:
                        type: string
                      ...
                      response:
                        ...
                        properties:
                          ...
                          percussionUrl:
                            type: string
                            description: >-
                              Percussion part audio URL (exists for split_stem
                              type)
                          stringsUrl:
                            type: string
                            description: >-
                          ...
                          synthUrl:
                            type: string
                            description: >-
                              Synthesizer part audio URL (exists for split_stem
                              type)
                          fxUrl:
                            type: string
                            description: >-
                          ...
                          brassUrl:
                            type: string
                            description: Brass part audio URL (exists for split_stem type)
                          woodwindsUrl:
                            type: string
                            description: >-
                              Woodwinds part audio URL (exists for split_stem
                              type)
                      successFlag:
                        type: string
          ...
          header:
            Authorization:
              ...
              description: >-
                ...
                1. Visit [API Key Management Page](https://sunoapi.org/api-key)
                to get your API Key
                ...
                allOf:
                  - type: string
                    description: >-
                      ...
                      provided, a random filename will be generated. If the same
